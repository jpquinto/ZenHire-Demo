        ...
        >   
                <div className="absolute top-[-5.5rem] right-[1%] flex items-center mb-3 z-10">
                    <div className="text-[5.5rem] font-bold opacity-50 text-primary">
                        <h1 style={{ background: 'linear-gradient(to right, #9FD47B, #CEE3CE)', WebkitBackgroundClip: 'text', color: 'transparent' }}>OVERVIEW</h1>
                    </div>
                </div>
                <div className="relative mb-[5rem] bg-muted border-4 border-primary p-5 rounded-3xl z-20">
                ...
                <div className="grid grid-cols-4 gap-x-4">
                    <div className="rounded-2xl border-4 border-secondary p-4">
                        <h1 className="text-center font-bold text-2xl">Total Apps</h1>
                        <p className="text-center font-semibold text-lg pt-2">{applications.length}</p>
                    </div>
                    <div className="rounded-2xl border-4 border-secondary p-4">
                        <h1 className="text-center font-bold text-2xl">Rejected</h1>
                    ...
                    <div className="rounded-2xl border-4 border-secondary p-4">
                        <h1 className="text-center font-bold text-2xl">Pending</h1>
                    ...
                    <div className="rounded-2xl border-4 border-secondary p-4">
                        <h1 className="text-center font-bold text-2xl">Interviews</h1>
